...
void setup() {
  ...
  //cP5.setColorValueLabel(0xffdddddd);
  cP5.setColor(new CColor(0xff00aa00,0xff006600,0xff00ff00,0xdd88ff88,0xffdddddd));
...
//    println(", value : "+theEvent.getController().getValue());
    ...
    // send file button
    if(theEvent.getController().getName() == "SEND FILE") {
...
//      send_file(file);
    ...
    if(theEvent.getController().getName() == "fractional_jog") {
      if ((int)theEvent.getController().getValue() == 1) FractionalJog = true;
